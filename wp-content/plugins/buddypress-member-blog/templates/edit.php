...
<div  class="bp-member-blog-container">
	<div class="bp-member-blog-post-form">
		...
		<label class="bp_memeber_blog_post_featured_cover" for="bp_member_blog_post_featured_image"><?php esc_html_e( 'Add Cover Image', 'buddypress-member-blog' ); ?>

			<input type="file" id="bp_member_blog_post_featured_image" placeholder="Cover Image Preview" name="bp_member_blog_post_featured_image" value="<?php echo esc_attr( $title ); ?>"/>
			...
			<?php do_action( 'bp_post_before_title', $post_id ); ?>
				...
				<input type="text" class="bp_member_blog_post_title" name="bp_member_blog_post_title" placeholder="Enter Title here..." value="<?php echo esc_attr( $blog_post->post_title ); ?>" required/>
			</label>
			...
			<label for="bp_member_blog_post_tag" class="bp_member_blog_post_tag_label"><?php esc_html_e( 'Post tag', 'buddypress-member-blog' ); ?>

				<input type="text" id="bp_member_blog_post_tag" class="regular-text" tabindex="-1"  name="bp_member_blog_post_tag" placeholder="<?php esc_html_e( 'Add post tags with Comma Separate...', 'buddypress-member-blog' ); ?>" value="">
			...
			<label for="bp_member_blog_post_content" class="bp_member_blog_post_content_label"><?php esc_html_e( 'Write Your Content Here', 'buddypress-member-blog' ); ?>
